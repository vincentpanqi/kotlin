...
open class JvmBasicScriptingHost<ScriptBase : Any, in CS : CompiledScript<ScriptBase>>(
    configurationExtractor: ScriptConfigurator,
    compiler: JvmScriptCompiler,
    runner: ScriptRunner<ScriptBase>
) : BasicScriptingHost<ScriptBase, CS>(configurationExtractor, compiler, runner)
